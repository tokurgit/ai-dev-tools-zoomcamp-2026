    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery', models.CharField(choices=[('immediate', 'Immediate'), ('digest', 'Digest')], default='digest', max_length=9)),
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('user', 'name'), name='unique_filter_profile_name_per_user')],
            },
        ),
    ]
